...
class GraphConvolution(nn.Module):
    """Graph Convolution Layer for GCN."""
...
class GCN(nn.Module):
    """
    GCN: Graph Convolutional Network for node feature aggregation.
    
    Uses graph convolution to aggregate neighbor features.
    """
...
class PUTransGCN(nn.Module):
    ...
    2. GCN: Aggregates graph structure information using graph convolution
